...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .bet-result .detail-item {
                display: flex;
                flex-direction: column;
                gap: 5px;
            }
            .bet-result .detail-label {
                opacity: 0.8;
                font-size: 0.8rem;
                font-weight: normal;
            }
            .bet-result .detail-value {
                font-size: 1.1rem;
            }
            .recent-bets-table {
                margin-top: 2rem;
            }
            .recent-bets-table table {
                width: 100%;
            ...
            .recent-bets-table .win {
                color: #10b981;
            }
            .recent-bets-table .lose {
                color: #ef4444;
            }
       </style>
    </head>
